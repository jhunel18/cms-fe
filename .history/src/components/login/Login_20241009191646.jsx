...
const Login = ({ onSubmit }) => {
  ...
  return (
    <Container fluid className="d-flex align-items-center justify-content-center" style={{ height: '100vh',boxDecorationBreak:'0px 0px 6px rgba(0, 0, 0, 0.5)' }}>
          ...
          <Card className="p-4 shadow-sm" style={{ width: '30rem' }}>
            ...
            <Form onSubmit={handleSubmit}>
              ...
              <div className="text-right mb-3">
                <Button variant="link" className="p-1">Forgot Password</Button>
              </div>
