...
const UsersTable = ({ users, loading, error, handleDeleteClick }) => {
  ...
  >
     <Row className="mb-4">
      ...
      >
       <Pagination
  alwaysShowPagination={false}  // Pagination only appears if necessary
  paginationRange={5}           // Show 5 page buttons at a time
  paginationSize="sm"           // Use small-sized pagination buttons
  paginationLabels={{ next: 'Next', prev: 'Previous' }} // Custom labels for next/prev
/>
      </Col>
      <Col>
      <Table responsive>
